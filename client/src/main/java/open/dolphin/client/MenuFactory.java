...
public class MenuFactory {
    ...
    @MenuAction
    public void showOrcaController() { main.sendToChain(GUIConst.ACTION_SHOW_ORCON); }

    @MenuAction
    public void stealthOrcaController() { main.sendToChain(GUIConst.ACTION_STEALTH_ORCON); }
