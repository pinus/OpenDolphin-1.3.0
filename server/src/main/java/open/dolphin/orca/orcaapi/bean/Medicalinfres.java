...
public class Medicalinfres {
     ...
     * 診療内容情報(繰り返し100) (例:  )
     */
    private MedicalinfInformation[] Medicalinf_Information;
     ...
     *
     * @return Medicalinf_Information
     */
    public MedicalinfInformation[] getMedicalinf_Information() {
        return Medicalinf_Information;
    }
     ...
     * Medicalinf_Information
     *
     * @param Medicalinf_Information to set
     */
    public void setMedicalinf_Information(MedicalinfInformation[] Medicalinf_Information) {
        this.Medicalinf_Information = Medicalinf_Information;
    }
}
