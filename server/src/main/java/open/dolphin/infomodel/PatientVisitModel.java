...
public class PatientVisitModel extends InfoModel {
    ...
    public String getPvtDateTrimTime() {
        return DateUtils.trimTime(pvtDate);
    }

    public String getPvtDateTrimDate() {
        return DateUtils.trimDate(pvtDate);
    }
    ...
    public String getPatientAgeBirthday() {
        return DateUtils.toAgeBirthdayFromIsoBirthday(getPatient().getBirthday());
    }
    ...
    public String getPatientAge() {
        return DateUtils.toAgeFromIsoBirthday(getPatient().getBirthday());
    }
